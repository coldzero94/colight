...
func (tx *Tx) init() {
	tx.AICallError = NewAICallErrorClient(tx.config)
	...
	tx.QuotaHitEvent = NewQuotaHitEventClient(tx.config)
...
// applies a query, for example: AICallError.QueryXXX(), the query will be executed

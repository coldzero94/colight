...
type UserProfileQuery struct {
	...
	withCompanyAnalyses  *CompanyAnalysisQuery
...
func (_q *UserProfileQuery) QueryExperiences() *ExperienceQuery {
...
func (_q *UserProfileQuery) QueryApplications() *ApplicationQuery {
...
// QueryCompanyAnalyses chains the current query on the "company_analyses" edge.
func (_q *UserProfileQuery) QueryCompanyAnalyses() *CompanyAnalysisQuery {
	query := (&CompanyAnalysisClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryCoverLetters chains the current query on the "cover_letters" edge.
func (_q *UserProfileQuery) QueryCoverLetters() *CoverLetterQuery {
...
func (_q *UserProfileQuery) QueryCoachingSessions() *CoachingSessionQuery {
...
func (_q *UserProfileQuery) QueryExperienceUsages() *ExperienceUsageQuery {
...
func (_q *UserProfileQuery) Clone() *UserProfileQuery {
	...
	return &UserProfileQuery{
		...
		withCompanyAnalyses:  _q.withCompanyAnalyses.Clone(),
...
func (_q *UserProfileQuery) WithExperiences(opts ...func(*ExperienceQuery)) *UserProfileQuery {
	query := (&ExperienceClient{config: _q.config}).Query()
...
func (_q *UserProfileQuery) WithApplications(opts ...func(*ApplicationQuery)) *UserProfileQuery {
	query := (&ApplicationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithCompanyAnalyses tells the query-builder to eager-load the nodes that are connected to
// the "company_analyses" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserProfileQuery) WithCompanyAnalyses(opts ...func(*CompanyAnalysisQuery)) *UserProfileQuery {
	query := (&CompanyAnalysisClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withCompanyAnalyses = query
	return _q
}

// WithCoverLetters tells the query-builder to eager-load the nodes that are connected to
// the "cover_letters" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserProfileQuery) WithCoverLetters(opts ...func(*CoverLetterQuery)) *UserProfileQuery {
	query := (&CoverLetterClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withCoverLetters = query
	return _q
}
...
func (_q *UserProfileQuery) WithCoachingSessions(opts ...func(*CoachingSessionQuery)) *UserProfileQuery {
	query := (&CoachingSessionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserProfileQuery) WithExperienceUsages(opts ...func(*ExperienceUsageQuery)) *UserProfileQuery {
	query := (&ExperienceUsageClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(userprofile.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.UserProfile.Query().
//		Select(userprofile.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (_q *UserProfileQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserProfile, error) {
	...
	if query := _q.withExperiences; query != nil {
		if err := _q.loadExperiences(ctx, query, nodes,
			func(n *UserProfile) { n.Edges.Experiences = []*Experience{} },
			func(n *UserProfile, e *Experience) { n.Edges.Experiences = append(n.Edges.Experiences, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withApplications; query != nil {
		if err := _q.loadApplications(ctx, query, nodes,
			func(n *UserProfile) { n.Edges.Applications = []*Application{} },
			func(n *UserProfile, e *Application) { n.Edges.Applications = append(n.Edges.Applications, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withCompanyAnalyses; query != nil {
		if err := _q.loadCompanyAnalyses(ctx, query, nodes,
			func(n *UserProfile) { n.Edges.CompanyAnalyses = []*CompanyAnalysis{} },
			func(n *UserProfile, e *CompanyAnalysis) { n.Edges.CompanyAnalyses = append(n.Edges.CompanyAnalyses, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withCoverLetters; query != nil {
		if err := _q.loadCoverLetters(ctx, query, nodes,
			func(n *UserProfile) { n.Edges.CoverLetters = []*CoverLetter{} },
			func(n *UserProfile, e *CoverLetter) { n.Edges.CoverLetters = append(n.Edges.CoverLetters, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withCoachingSessions; query != nil {
		if err := _q.loadCoachingSessions(ctx, query, nodes,
			func(n *UserProfile) { n.Edges.CoachingSessions = []*CoachingSession{} },
			func(n *UserProfile, e *CoachingSession) {
	...
	if query := _q.withExperienceUsages; query != nil {
		if err := _q.loadExperienceUsages(ctx, query, nodes,
			func(n *UserProfile) { n.Edges.ExperienceUsages = []*ExperienceUsage{} },
...
func (_q *UserProfileQuery) loadExperiences(ctx context.Context, query *ExperienceQuery, nodes []*UserProfile, init func(*UserProfile), assign func(*UserProfile, *Experience)) error {
	...
	query.Where(predicate.Experience(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(userprofile.ExperiencesColumn), fks...))
	}))
...
func (_q *UserProfileQuery) loadApplications(ctx context.Context, query *ApplicationQuery, nodes []*UserProfile, init func(*UserProfile), assign func(*UserProfile, *Application)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*UserProfile)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(application.FieldUserID)
	}
	query.Where(predicate.Application(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(userprofile.ApplicationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UserProfileQuery) loadCompanyAnalyses(ctx context.Context, query *CompanyAnalysisQuery, nodes []*UserProfile, init func(*UserProfile), assign func(*UserProfile, *CompanyAnalysis)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*UserProfile)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(companyanalysis.FieldUserID)
	}
	query.Where(predicate.CompanyAnalysis(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(userprofile.CompanyAnalysesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UserProfileQuery) loadCoverLetters(ctx context.Context, query *CoverLetterQuery, nodes []*UserProfile, init func(*UserProfile), assign func(*UserProfile, *CoverLetter)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*UserProfile)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(coverletter.FieldUserID)
	}
	query.Where(predicate.CoverLetter(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(userprofile.CoverLettersColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UserProfileQuery) loadCoachingSessions(ctx context.Context, query *CoachingSessionQuery, nodes []*UserProfile, init func(*UserProfile), assign func(*UserProfile, *CoachingSession)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*UserProfile)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(coachingsession.FieldUserID)
	}
	query.Where(predicate.CoachingSession(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(userprofile.CoachingSessionsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UserProfileQuery) loadExperienceUsages(ctx context.Context, query *ExperienceUsageQuery, nodes []*UserProfile, init func(*UserProfile), assign func(*UserProfile, *ExperienceUsage)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*UserProfile)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(experienceusage.FieldUserID)
	}

...
export function ExperienceForm({
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
      ...
      {/* STAR section */}
      <section className="space-y-4">
        <h2 className="text-lg font-semibold text-gray-900">STAR 구조</h2>
      ...
      {/* Free text section */}
      <section className="space-y-4">
        <h2 className="text-lg font-semibold text-gray-900">자유 입력</h2>
      ...
      <div className="flex gap-3 justify-end border-t border-gray-100 pt-6">
        <button
          type="button"
          onClick={onCancel}
          className="rounded-lg px-6 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 transition-colors"
        ...
        <button
          type="submit"
          className="rounded-lg bg-gray-900 px-6 py-2 text-sm font-medium text-white hover:bg-gray-800 transition-colors disabled:opacity-50"
          disabled={isSubmitting}
        >
          {isSubmitting
            ? "저장 중..."
